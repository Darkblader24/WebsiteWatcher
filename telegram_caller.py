...
# Author Gabriel Jacobo https://mdqinc.com/blog/2018/08/telegram-voip-calls-using-python/
...
import json
import base64
from telegram.client import Telegram  # Needs telegram-python
from tgvoip import call               # needs something else, see website from above
